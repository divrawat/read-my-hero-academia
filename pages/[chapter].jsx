...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Read ${MANGA_NAME} chapter ${chapterNumber} online at ${DOMAIN_NAME} in HD quality. All ${MANGA_NAME} latest manga and manhwa chapters in high quality english are always updated regularly at our website.`;
        ...
        "@graph": [
            {
                ...
                "author": {
                    "name": "Divyanshu Singh Raj Rawat",
                    "@id": `${DOMAIN}/#/schema/person/7edc4ad8bsc84d70b9422d149194081b`,
                },
                "headline": `${MANGA_NAME} Chapter ${chapterNumber}`,
                "mainEntityOfPage": {
                    "@id": `${DOMAIN}/${URL}`
            ...
            },
            {
                ...
                "thumbnailUrl": `${IMAGES_SUBDOMAIN}/chapter-${chapterNumber}/1.webp`,
                "description": `Read ${MANGA_NAME} Chapter ${chapterNumber} online at ${DOMAIN_NAME} which is the best website for reading manga online in very high quality.`,
                "breadcrumb": {
            ...
            },
            {
                ...
                "@id": `${DOMAIN}/#website`,
                "url": `${DOMAIN}`,
                "name": "My Hero Academia Manga Blog",
                "description": `Read ${MANGA_NAME} Chapter ${chapterNumber} online at ${DOMAIN_NAME} which is the best website for reading manga online in very high quality.`,
                "publisher": {
                    "@id": `${DOMAIN}/#organization`
                },
            ...
            },
            {
                ...
                "logo": {
                    ...
                    "width": 192,
                    "height": 192,
                    "caption": "My Hero Academia Manga Blog"
                },
                "sameAs": []
            },
            {
        ...
        <>
            ...
            <article>
                ...
                <div className="flex justify-center">
                    <iframe width="300" height="315" src="https://www.youtube.com/embed/22hBq1cvemE?si=bnBJYEqAWfKvXt6Z" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </div>
